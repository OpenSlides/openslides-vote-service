...
require (
	github.com/OpenSlides/openslides-autoupdate-service v0.4.1-0.20230519212348-5aab6b37920d
	github.com/OpenSlides/vote-decrypt v0.0.0-20230510045515-df8672d3571c
