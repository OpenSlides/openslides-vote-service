...
`{"yes":"32","no":"20","abstain":"10","invalid":2,"turnout":64}`

Attributes with a zero get discarded.

The values are decimal values decoded as string. See [Vote
Weight](#vote-weight). Only the values of `invalid` and `turnout` are integers,
since they are absolut numbers and not affected by bote weight. The field
`turnout` is the number of ballots. It contains valid and invalid ballots.
...
`{"1":"40","2":"23","nota":"6","abstain":"7","invalid":3,"turnout":80}`
...
`{"1":"40","2":"23",abstain":"7","invalid":3,"turnout":60}`
...
`{"1":{"yes":"5","no":"1"},"2":{"yes":"1","abstain":"6"},"invalid":1,"turnout":7}`
